...
# xPL source name
	...
	def onPlayBackStarted(self):
		xbmc.log("fatest: play");
		self.monitorXbmc("play")

	def onPlayBackEnded(self):
		xbmc.log("fatest: stop");
	...
	def parseBroadcast(self, data):
		...
		if (values['target'] != "*" and values['target'] != "c99org-boxee.*" and values['target'] != self.source) or values['source'] == self.source:
			return
